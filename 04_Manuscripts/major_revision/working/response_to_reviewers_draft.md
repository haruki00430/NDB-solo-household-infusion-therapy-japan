...
We are grateful to the Editor and both reviewers for a careful, constructive, and rigorous review, and we thank them for the time and expertise they invested in evaluating our manuscript. The manuscript continues to address the same research question as the original submission: whether the prefectural elderly solo household rate is associated with large-volume infusion therapy utilization, and whether such an association is independent of population age structure, healthcare supply, and heat exposure. In direct response to Reviewer 2's central request, we retained the originally submitted exposure (percentage of all households consisting of one person aged ≥65 years) and added prefectural ageing rate to the same model. The exposure coefficient changed from 656.2 (95% CI 326.9–985.6) to 306.1 (95% CI −71.3–683.5), a descriptive attenuation of 53.3%, and the association was no longer statistically significant. Further adjustment for healthcare supply (β = 94.1) and heat exposure attenuated the estimate further, to near zero and reversed in sign (β = −9.4; 95% CI −493.9–475.1; p = 0.970). Using the originally submitted 2020 population denominator, the unadjusted point estimate (β = 723.4) was exactly reproduced, and the same attenuation pattern was observed. We also examined a complementary exposure using the older population as the denominator, which showed no evidence of association with infusion utilization at any stage. These analyses materially changed our conclusion: we no longer report the association as an independent, robust ecological finding. We have revised the Title, Abstract, Introduction, Results, Discussion, and Conclusions accordingly, while keeping the original research question, outcome, and primary exposure unchanged. We believe the manuscript is substantially strengthened as a result of the Editor's and reviewers' comments, and we address every point individually below.

All line numbers below refer to the revised clean manuscript (continuous line numbering) and, where useful, the corresponding numbered subsection (e.g., "Methods §5," "Results §2").
...
Reviewer 1's overall comment: "I think it was an interesting topic… My main concerns are that the relationship between heat exposure and dehydration may not be linear… AC in homes was high but it is unknown if it was used; and it was unknown what other health conditions older adults had that may also be associated with dehydration… I think with more literature in the introduction, additional details in the methods and a toned down 'association' between heat and therapy, this does present an interesting ecological study."

**Response:** We thank Reviewer 1 sincerely for this constructive assessment and for the considerable time and care evident in the 35 detailed inline comments. We address every comment below, in order, and we believe the manuscript has improved substantially thanks to this feedback.

### R1-1 (anchor: "47 Japanese prefectures")
...
**Response:** We thank the reviewer for catching this. "Wet-bulb globe temperature (WBGT)" is now spelled out at first use (Methods §1, line 102).

### R1-4 (anchor: "limited informal monitoring")

> "Please explain what is informal monitoring. Monitoring of what?"

**Response:** We thank the reviewer for asking us to clarify this. We revised this passage to specify concretely what is meant (e.g., a household member or neighbor noticing signs of heat illness, prompting fluid intake, or encouraging use of cooling), rather than using the unexplained term "informal monitoring" (Introduction/Discussion, revised wording).

### R1-5 (anchor: reference list at end of sentence)

> "Would be better to put the references next to the points in the sentence and not all at the end."

**Response:** We thank the reviewer for this helpful suggestion and have distributed citations next to the specific claims they support throughout the revised Introduction and Discussion rather than grouping them at sentence end.
...
> "Please explain what is N and what these numbers mean, and how can 47 equal 0.085?"

**Response:** We thank the reviewer for pointing out this confusing wording. We revised this sentence for clarity: N is the number of prefectures (47), and the Cook's distance influence threshold is conventionally set at 4/N (i.e., 4 divided by 47 ≈ 0.085), not "N = 0.085." The corrected wording appears in the Results/Online Resource 1 description of influence diagnostics.

### R1-19 (anchor: "adjusted")
...
> "Does this mean 12.6 per 100 000? Please be specific to ensure this is a rate and not just a number."

**Response:** We thank the reviewer for catching this ambiguity. Table 1 now specifies units for every variable explicitly (e.g., "%" for the exposure, "per 100,000" for the outcome) (Table 1).
...
**Response:** We thank the reviewer for this important point. The original policy recommendation to prioritize outreach based on this indicator has been removed from the Conclusions, since the underlying association was not robust to adjustment (Conclusions, lines 363–380).
...
**Response:** We thank the reviewer for this thoughtful point. We have removed the specific policy recommendation referencing "cooling support" as a prescribed action, given that the underlying association is no longer supported after adjustment (Conclusions, lines 363–380).

### R1-30 (anchor: "causes")

> "Such as, please give examples."

**Response:** We thank the reviewer for this request; it is addressed via the expanded discussion of non-heat-related indications for G004 infusion therapy (see R1-28 response above).

### R1-31 (anchor: "Sixth, unmeasured confounding by socioeconomic status, healthcare access, chronic disease, medication use, housing, and urban heat islands may remain.")
...
> "References should be checked for correct DOIs."
...
### R1-33 (anchor: Miyatake DOI)

> "Wrong DOI… doi: 10.1007/s12199-011-0221-2."

**Response:** We thank the reviewer for identifying this error. Corrected exactly as specified; the reference list now reads doi:10.1007/s12199-011-0221-2 (References, line 491).

### R1-34 (anchor: "Table")

> "These is no need for three decimal places in this type of study." [sic]

**Response:** We thank the reviewer for this practical suggestion; we agree. Tables now use restrained decimal precision appropriate for N=47 (e.g., one decimal place for unstandardized coefficients, three for standardized coefficients and R², consistent with conventional reporting) (Table 1; Table 2).

### R1-35 (anchor: figure R² comment)

> "The R-square value for both of these figures is very low, i.e., very weak regression results as indicated by little pattern shown by the dots. Not sure of the value of these relationships."

**Response:** We thank the reviewer for this important concern, which is central to our revised interpretation. The revised Results and Discussion explicitly report that the exposure's unique contribution (partial R²) declines to near zero after full adjustment (partial R² = 0.272, 0.056, 0.004, and <0.001 for O-A through O-D; Table 2), and we no longer present the original median-split figure as a primary result (it is retained only as an audit-only reproduction in Online Resource 1). We thank the reviewer again for the care taken in reviewing every detail of the manuscript.

---

## Response to Reviewer 2

Reviewer 2's overall comment: "This is an important and timely study… However, the central interpretation needs further support, and I recommend major revision."

**Response:** We thank Reviewer 2 sincerely for this careful, constructive, and incisive assessment. We agree with this assessment and address each numbered point below.
...
**Response:** We thank the reviewer for these detailed and constructive comments; we agree. The outcome is now described throughout as large-volume infusion therapy utilization (procedure code G004, ≥500 mL), explicitly noted as not specific to heat illness or dehydration (Methods §2, lines 105–111; Discussion, lines 323–326). The title has been changed to a descriptive, non-evaluative form that does not imply direct evaluation of a warning system (line 1). We have explained the source-year alignment for each variable in the Limitations (Discussion, lines 343–348: 2020 Census for household composition and the primary exposure; 2023 population estimates for the outcome denominator and ageing rate; 2023 Survey of Medical Institutions for healthcare supply; 2014 survey for air-conditioning ownership, not used in the primary models). Regarding the GitHub link: we agree that "XXX" could read as an unfilled placeholder. We have renamed the repository and corrected the URL in the Data Availability statement, which now reads https://github.com/haruki00430/NDB-solo-household-infusion-therapy-japan (Data Availability, lines 394–397); the prior URL redirects automatically to the new one. We also now explicitly frame the study as hypothesis-generating in the Discussion and Conclusions, given the ecological, cross-sectional, and single-year design (Discussion, lines 355–356). We thank the reviewer once more for the depth and rigor of this review, which has substantially improved the manuscript.
