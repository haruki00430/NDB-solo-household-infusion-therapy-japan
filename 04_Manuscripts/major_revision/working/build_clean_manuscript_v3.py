...
# ---------------------------------------------------------------------------
REPLACEMENTS = {
    0: "Prefecture-Level Older-Adult Solo Household Rate and Large-Volume Infusion Therapy Utilization in Japan: An Ecological Study",
    ...
    20: "The prefectural elderly solo household rate was associated with large-volume infusion therapy utilization in the unadjusted analysis. However, the estimate was substantially attenuated and was no longer statistically significant after adjustment for population age structure. Further adjustment for healthcare supply and summer heat exposure reduced the estimate toward zero. These findings do not support an independent ecological association between living-alone indicators and infusion therapy utilization and highlight the need to account for population structure when evaluating social vulnerability in heat-health research.",
    ...
    60: "A comparison with general outpatient utilization (R5 Patient Survey) did not support outcome specificity for infusion therapy and is reported in the supplementary material (Online Resource 1), using standardized coefficients only; the previously reported raw-coefficient comparison is not valid because the two outcomes are measured on different scales and has been removed.",
